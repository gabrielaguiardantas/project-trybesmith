...
const verifyProductFields = (req: Request, res: Response, next: NextFunction) => {
  const { error } = schemas.addProductSchema.validate(req.body);
  if (error) {
...
export default verifyProductFields;